...
//    public $isSuperuser = '\Yii::app()->user->checkAccess("admin")';
    public $isSuperuser = '\Yii::$app->user->identity->isAdmin';
...
//    public $userIDExpr = '\Yii::app()->user->id';
    public $userIDExpr = '\Yii::$app->user->identity->id';
...
//        $model = CommentSettings::load();
    ...
    {
//        return $this->evaluateExpression($this->userIDExpr); \\TODO evaluateExpression
    ...
    public function loadUser()
    {
        ...
        return $userModel->findOne($this->getUserID());
    }
