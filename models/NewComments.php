 ...
 */
class NewComments extends \yii\db\ActiveRecord
{
	/**
	...
	public function rules()
	{
		return array(
			...
			[['comment_id', 'user_id'], 'safe', 'on'=>'search'],
		);
	}
     ...
     * @return $this
     */
    public function user($id) //TODO поиск по юзеру
    {
        if ( empty($id) )
            return $this;
...
//	}
	...
	{
		return new NewCommentsQuery(get_called_class());
	}
